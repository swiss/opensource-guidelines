...
Article 9 of the Federal Act of 17 March 2023 (SR 172.019) on the Use of
...
The Federal Act of 9 October 1992 (SR 231.1) on Copyright and Neighbouring
...
definition of the [Open Source Initiative (OSI)](https://opensource.org/):
...
avoids [vendor lock-in](https://en.wikipedia.org/wiki/Vendor_lock-in).
...
- European Union Public Licence (EUPL) - The EUPL itself has a strong copyleft, but due to the opening clause, a transfer to licences with a weak
copyleft is possible, so that the protection is limited.
...
![Compatibility of open source licences](./assets/em002-3//media/image1.png)

Figure 1: Compatibility of open source licences (based on diagram by David A. Wheeler, 2007 and [https://www.gnu.org/licenses/license-list.en.html](https://www.gnu.org/licenses/license-list.en.html))
...
- Desired checking (*[Em002-2.1 Preliminary Assessment Checklist](em002-2.1.md))*
...
this in *[Em002-2.3 Release and Publication Checklist](em002-2.3.md)*.
...
- Black Duck ([www.blackducksoftware.com](https://www.blackducksoftware.com)),

- FOSSA ([www.fossa.com](https://www.fossa.com)),
...
Table 2: Licence to be used depending on use case for the release of new
software according to Art. 9 EMOTA (bold=preferred for use)

![Decision tree for licence selection within the Federal
Administration](./assets/em002-3//media/image2.png)
...
the opposite case, a fork is almost unavoidable.
...
authorities, provided that the corresponding [GTC](https://www.bkb.admin.ch/bkb/de/home/themen/agb.html) of the
...
for example in international relations. When companies
...
contributors via a simple OSS licence.
...
*[Em002-2.1 Preliminary Assessment Checklist](em002-2.1.md)* and *Em002-4.1 OSS
Community Checklist*.
...
licence [(CC-0, CC-BY, CC-BY-SA](https://www.creativecommons.ch/) or possibly LGPL) should be used
for documentation.
...
Duck or FOSSA offer various proprietary solutions that can
...
| Description       | Trust Broker Swiss provides federation services between relying parties (applications, service providers, other IAM Systems or policy enforcement points) and identity Providers (IdP, aslo called claims providers) using trusted attribute stores to enrich authenticated users.<br>It enables identity/claims providers and relying parties to exchange information via a third party hiding the IdP specifics providing a unified or at least additionally verified identity. |
| Year              | 2024                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| Licence           | AGPL                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
### GWEN / ampycloud / c4dl-multi / dvas /…
...
### EMSG application (asset management in settlement areas)
...
### Various libraries on open data (e.g. linked data)
...
### Apache FOP customised for archivable PDF
...
### Legally compliant electronic input with eKomm
