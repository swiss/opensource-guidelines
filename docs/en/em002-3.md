...
|The goal is the widest possible distribution, e.g. for a reference implementation<sup>12</sup> (e.g. for software also to be used in commercial solutions).| **MIT**<br> BSD v3<br> Apache Licence 2.0<br> LGPL v3| In this case, no copyleft should be used.|
