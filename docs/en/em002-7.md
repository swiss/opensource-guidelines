...
<table style="width: 100%; border-collapse: collapse; font-family: sans-serif; border: 1px solid black;">
  ...
  <tr style="background-color: #d9d9d9; font-weight: bold;">
    <td style="padding: 5px; border: 1px solid black; width: 25%;">Lifecycle costs<br>→ WTO threshold?<sup>31</sup></td>
    <td style="padding: 5px; border: 1px solid black; width: 15%;">In-state?<sup>32</sup></td>
    <td style="padding: 5px; border: 1px solid black; width: 20%;">WTO tender required?<sup>33</sup></td>
  ...
  <tr>
    ...
    <td style="background-color: #f2f2f2; padding: 5px; border: 1px solid black;">No</td>
    <td style="padding: 5px; border: 1px solid black;">No <sup>34</sup></td>
