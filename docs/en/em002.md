...
Under Article 9 paragraph 1 of the Federal Act of 17 March 2023 (SR 172.019) on
...
revise the practical guidelines *[Em002-1](em002-1.md)* together with all
...
and EMOTA. [SR 172.019](https://www.fedlex.admin.ch/eli/cc/2023/682/de). These contain a direct or indirect reference to the
...
up in the ***[Digital Public Services Switzerland Strategy 2024–2027](https://www.digital-public-services-switzer-land.ch/strategy)***. The Confederation and cantons will create
...
According to the ***[Digital Switzerland Strategy](https://digital.swiss/en/)*** it is crucial
...
topic for 2023](https://digital.swiss/en/strategy/focus-topics/digital-sovereignty).

In the ***[Open Government Data Strategy Switzerland (2019–2023)](https://www.bfs.admin.ch/bfs/en/home/services/ogd/documentation.html)***
...
has launched the *[opendata.swiss](https://opendata.swiss/en)* portal for this purpose. Federal
offices, cantons, cities and other public organisations have currently
published over 11,700 datasets there.

The [Open Government Data Master Plan 2024–2027](https://www.bfs.admin.ch/bfs/en/home/services/ogd/documentation.html) implements the Open
by Default principle.

![Distinction between consuming, contributing
ceptions](./assets/em002//media/image1.png)

Figure 1 Distinction between consuming, contributing
ceptions set out in Art. 9 EMOTA (third-party
and creating open source software
...
created. [Bitkom Leitfaden Open Source Softawre 3.1](https://test.bitkom.org/sites/main/files/2023-03/BitkomLeitfadenOpenSourceSoftware31.pdf), Section 4 (in German).
...
in *[Em002-2 Instructions for Publishing OSS](em002-2.md)* and the
associated checklists define how to work with a platform and which
properties it must fulfil.

The **choice of licence** is dealt with in the *[Em002-3 OSS Licensing Guidelines](em002-3.md)*, which presents a selection of standard licences
...
EMOTA information sheet](https://intranet.bbl.admin.ch/bbl_kp/de/home/informatik/beschaffung-buerotechnik-informatik-des-bbl/werkzeugkasten.html)* is available in German (see Figure 2).
...
![Documents related to Art. 9 EMOTA](./assets/em002//media/image2.png)

Figure 1: Documents related to Art. 9 EMOTA
...
| Objectives                                      | Measures                                                                                                                                                                                                                                                                                                                        |
|-------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A) Compliance with legal requirements (EMOTA)   | 1) Implement the [Em002-1 Practical Guidelines for Open Source Software in the Federal Administration](em002-1.md)<br>2) Implement the [Em002-2 Instructions for Publishing OSS](em002-2.md) and the tools derived from that.<br>3) Procurement authorities build up open source know-how and thus support the Federal Administration. |
| B) Increase innovation and efficiency     | 1) Implement the [Em002-1 Practical Guidelines for Open Source Software in the Federal Administration](em002-1.md)<br>3) The procurement authorities can deal with open source and optimally support Art. 9 EMOTA.<br>8) Promote community building                                                                                         |
| C) Promote a culture of collaboration           | 1) Implement the [Em002-1 Practical Guidelines for Open Source Software in the Federal Administration](em002-1.md)<br>4) Promote knowledge and experience exchange<br>8) Promote community building<br>9) Examine the possibility of establishing own publication platform; promote Open Development                                        |
| D) Create clarity and minimise risks         | 1) Implement the [Em002-1 Practical Guidelines for Open Source Software in the Federal Administration](em002-1.md)<br>2) Implement the [Em002-2 Instructions for Publishing OSS](em002-2.md) and the tools derived from that.                                                                                                          |
...
| F) Increase<br>attractiveness as an IT employer | 5) Promote and communicate an open source culture<br>8) Promote community building                                                                                                                                                                                                                                              |


## Description of the measures

### Measure 1: Implement the Practical Guidelines for Open Source Software in the Federal Administration [Em002-1]
...
As a brief introduction to the topic, a EMOTA and OSS Factsheet and the FAQ on OSS and Art. 9 EMOTA are available.

### Measure 2: Implement the Instructions for Publishing Open Source Software [Em002-2] and the tools derived from that
...
In order to be perceived by the public as an 'open source-friendly' employer, the various measures and the open source solutions used should be actively communicated in the form of a technology radar. Technology radars should be used as widely as possible. This means, if possible, at the level of the federal authorities or even the Federal Administration. For employer attractiveness, it is also important to allow federal employees to contribute to existing open source software.
...
The joint procurement of services for open source software should increase the reliability of maintenance and support in operation and simplify the use of open source solutions. Based on the technology radar (see Measure 5), services for the most widespread open source systems and technologies should be centrally procured. These services can then be obtained by all offices as needed. This concerns support for the software in use. Third party support for software released under EMOTA is possible and may be charged for. This is covered in [Em002-4 OSS Community Guidelines](em002-4.md).
...
- This has resulted in the new objective A and derived measures:
  ...
  - Measure 9: Examination of own publication platform. Promotion of Open Development.
...
the **[OSS documents of the Canton of Bern](https://github.com/kanton-bern/oss)**, which are released under a
BSD3 licence.
...
![Documents in connection with Art. 9 EMOTA](./assets/em002//media/image2.png)
Figure *3*: Documents in connection with Art. 9 EMOTA

## General references

All references to the Em002 document set can be found here in this document.*
